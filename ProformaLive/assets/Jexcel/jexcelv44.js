    ...
    var jexcel = (function (el, options) {
        ...
        obj.createTable = function () {
            ...
            if (obj.options.filters == true) {
                ...
                td.className = 'jexcel_custom_filter';
        ...
        */
        ...
        obj.openFilter = function (columnId) {
            if (!obj.options.filters) {
                ...
                //added by ashok on 12 12 2020.
                //below 2 line code will help to remove blank text from the table filter.
                var removeblank = optionsFiltered.indexOf(optionsFiltered.find(x => x.name === 'Blanks'));
                optionsFiltered.splice(removeblank, 1);
                //-------------------------------------
        ...
        obj.closeFilter = function (columnId) {
            ...
            //ashok modified this code
            function escapeRegExp(string) {
                return string.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
            }

            function replaceAll(str, term, replacement) {
                return str.toString().replace(new RegExp(escapeRegExp(term), 'g'), replacement);
            }
            ...
            //    if (obj.rows[i].isConnected === false) {
        ...
        obj.updateResult = function () {
            ...
            //    var displaystatus = obj.rows[k].style.display;
            //    if (displaystatus === 'none') {
            //        console.log(obj.rows[k]);
            //    }
            //}

            //for (var j = 0; j < obj.options.footers.length; j++) {

            //    console.log(obj.tfoot.children[j].children[2]);
            //    console.log(obj.tfoot.children[j]);
            //    obj.tfoot.children[j].children[9].innerHTML = 12;

            //    //obj.tfoot.children[j][0] = 0.00;
